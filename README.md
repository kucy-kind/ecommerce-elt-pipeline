...
### 商家
**日表：**[商家日报](http://192.168.160.129:3000/public/dashboard/0ac2efec-f43c-43f0-b09e-0ad6d39203cd?date=2026-04-20&id=MERC2640789)
**月表：**
**年表：**

### 平台
**日表：**[平台日报](http://192.168.160.129:3000/public/dashboard/c10e84d4-83f2-4b74-bd65-493e95862cfc?date=2026-04-20)
**月表：**
**年表：**
.  
├── airflow/  
│ ├── dags/ # Airflow DAG 定义文件  
│ ├── logs/ # 运行时日志（内容太多不上传 Git）  
│ └── plugins/ # 自定义插件  
├── dbt/ # dbt 项目根目录  
│ ├── models/ # SQL 模型（分层）  
